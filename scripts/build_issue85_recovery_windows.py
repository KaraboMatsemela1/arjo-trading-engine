#!/usr/bin/env python3
"""Build copyright-bounded lexical windows from directly acquired Issue #85 targets.
...
and the shared pre-SPEC anti-bias guard rejects outcome-contaminated windows.
"""
...
def main() -> int:
    ...
    parser.add_argument("--max-windows-per-source", type=int, default=18)
    ...
    print(
        json.dumps(
            {"sources": len(sources), "captured": report["captured_source_count"], "windows": total_windows},
            sort_keys=True,
        )
    )
    return 0
