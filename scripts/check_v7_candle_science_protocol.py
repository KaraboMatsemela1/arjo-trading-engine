...
PROTOCOL=Path('research/profitability/v7_candle_science_protocol_v1.json');BOUNDARY=Path('research/profitability/v7_candle_science_preoutcome_boundary_v1.json');SOURCE=Path('research/profitability/v7_candle_science_source_recovery.md');EXPECTED='28005dd5cfd6a443ef87e0c5c5a21537113096702600c2f1e2a83b1ce18e14be'
...
def verify()->None:
    ...
    for key,value in b.items():
        if key.startswith('v7_') and key not in {'v7_h4_accessed','v7_h1_accessed','v7_m1_accessed','v7_mid_accessed','v7_bid_ask_accessed','v7_triggers_constructed','v7_fills_evaluated','v7_pnl_accessed','v7_expectancy_accessed','v7_profit_factor_accessed','v7_bootstrap_outcomes_accessed','v7_forward_outcomes_accessed'}:continue
